  ...
  return (
    <section id="home" className="flex flex-col justify-center items-center min-h-screen pt-16 pb-20 px-4">
      <h1 className="text-5xl md:text-6xl font-bold mb-6 text-center leading-tight">
        Hi, I'm <span ref={nameRef} className="text-white hover:text-orange-300 transition-all duration-300 inline-block cursor-pointer px-2">Arijit Singha Roy</span>,
      </h1>
      <h2 className="text-4xl md:text-5xl font-bold mb-6 text-center">
        <span className="animate-text-slide inline-block">a QA Software Engineer</span>
      </h2>
